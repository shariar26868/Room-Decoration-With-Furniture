...
# from ai_backend.api import upload, selection, furniture, generation, decorative
# from ai_backend.services.aws_service import init_aws_service
# from ai_backend.services.product_service import ProductService
# from ai_backend.config import (
#     AWS_ACCESS_KEY_ID,
...
#     title="AI Interior Designer API",
#     version="2.1.0",
#     description="AI-powered interior design with 25,000+ real products + custom decorative items",
#     lifespan=lifespan
# )
...
# app.include_router(selection.router, prefix="/api/selection", tags=["2. Selection"])
# app.include_router(furniture.router, prefix="/api/furniture", tags=["3. Furniture"])
# # app.include_router(decorative.router, prefix="/api/decorative", tags=["4. Decorative Items (Optional)"])
# app.include_router(generation.router, prefix="/api/generation", tags=["5. Generation"])
...
#         "products": product_service.total_products if product_service else 0,
#         "features": [
#             "Real furniture search from 25,000+ products",
#             "Custom decorative items upload (lamps, clocks, paintings, etc.)",
#             "AI-powered room composition",
#             "Background removal for natural placement"
#         ],
#         "docs": "/docs"
#     }
...
# ✅ CORRECT IMPORT (remove 'decorative')
from ai_backend.api import upload, selection, furniture, generation
from ai_backend.services.aws_service import init_aws_service
from ai_backend.services.product_service import ProductService
from ai_backend.config import (
